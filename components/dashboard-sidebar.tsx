      ...
      <header className="lg:hidden flex items-center justify-between bg-card border-b border-border px-6 py-4 z-40 w-full fixed top-0 left-0 select-none">
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">
            {userRole === "BUSINESS_OWNER" ? "Business Owner" : "Enterprise Staff"}
          </span>
        </div>
        <button
      ...
      >
        <div className="space-y-8">
          ...
          <div className="space-y-1 select-none">
            ...
            <span className="text-[10px] font-heading text-muted-foreground uppercase font-bold tracking-widest block">
              {businessName}
            </span>
          </div>
